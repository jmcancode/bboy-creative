                    ...
                    >
                      ...
                      <div className="ptf-phone-block">
                        ...
                        <div className="ptf-phone-block__phone">
                          <a href="tel:+3796354868">(+1) 210.454.4340</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-xl-7">
                    ...
                    >
                      <h2 className="h1 large-heading has-accent-1">
                        App Development & Creative Problem Solving
                      </h2>
                    </div>
                  </div>
                ...
                <div className="row">
                  <div className="col-lg-5 offset-lg-7">
                    ...
                    >
                      ...
                      ></div>
                      <h3 style={{ maxWidth: "30rem", color: "#fff" }}>
                      ...
                      >
                        ...
                        with our clients. We are here to help you succeed in
                        your business goals.
                      </p>
                    </div>
                    {/* <!--Spacer--> */}
            ...
            <section className="ptf-custom--1569">
              ...
              <div className="container">
                ...
                <div
                  ...
                  data-aos-delay="0"
                >
                  <h2 className="h1 large-heading has-accent-1">The Crew </h2>
                </div>
                {/* <!--Spacer--> */}
                <div
                  className="ptf-spacer"
